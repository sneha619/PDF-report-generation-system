    ...
    <div className="flex justify-center items-center min-h-[80vh] px-4 py-8">
      <div className="bg-white rounded-lg shadow-md p-8 w-full max-w-md">
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-center text-gray-800 flex-1 pr-10">Login to Your Account</h2>
        </div>
        ...
        <p className="text-center mb-0 text-gray-500">
          Don't have an account? <Link to="/signup" className="text-indigo-800 font-medium hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
